...
- Blendarı önce düşük, sonra yüksek hızda çalıştırın.
...
- 3 + 1/5 su bardağı un
- 1 su bardağı bitkisel süt (soya, badem, hindistan cevizi, yulaf vb)
...
- Bir kapta un, tuz, mahlep ve hamur kabartma tozunu karıştırın.
- Bu karışıma bitkisel süt, sirke, limon suyu ve sirkeyi ekleyin.
- Kaptaki tüm malzemeleri hafifçe karıştırın ve zeytin ile dereotunu da ekleyin.
- Hamuru ele yapışmayan bir kıvam alana dek yoğurun.
- Hamurdan küçük parçalar alın ve şekil vererek tepsiye dizin.
- Üzerine pekmez-su karışımını sürün.
- Susam, çörek otu ve haşhaş ile süsleyin.
- Önceden ısıtılmış 190° fırında 15 dakika pişirin.
